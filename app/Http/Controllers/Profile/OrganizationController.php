...
class OrganizationController extends Controller
{
    public function index (Request $request)
    {
        ...
        return view('profile.organizations.index', ['organizations'=>$organizations])->with('1',(request()->input('page',1) -1) *5);
    }

    public function create()
    {
        return view('profile.organizations.create');
    }
    ...
    public function edit($id){
        ...
        return view('profile.organizations.edit', ['organization'=>$organization]);
    }
